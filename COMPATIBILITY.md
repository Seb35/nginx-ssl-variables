...
Pure Lua:
* SSL_SESSION_ID: (TODO) uppercased $ssl_session_id
...
* SSL_VERSION_INTERFACE: (TODO) can be computed with Lua OpenSSL
* SSL_VERSION_LIBRARY: (TODO) can be computed with Lua OpenSSL
* SSL_CLIENT_M_VERSION: (TODO) can be computed from $ssl_client_raw_cert with Lua OpenSSL
* SSL_CLIENT_S_DN_'x509': (TODO) can be computed from $ssl_client_raw_cert with Lua OpenSSL
* SSL_CLIENT_I_DN_'x509': (TODO) can be computed from $ssl_client_raw_cert with Lua OpenSSL
* SSL_CLIENT_V_START: (TODO) can be computed from $ssl_client_raw_cert with Lua OpenSSL
* SSL_CLIENT_V_END: (TODO) can be computed from $ssl_client_raw_cert with Lua OpenSSL
* SSL_CLIENT_V_REMAIN: (TODO) can be computed from $ssl_client_raw_cert with Lua OpenSSL
* SSL_CLIENT_A_SIG: (TODO) can be computed from $ssl_client_raw_cert with Lua OpenSSL
* SSL_CLIENT_A_KEY: (TODO) can be computed from $ssl_client_raw_cert with Lua OpenSSL

A first search of a Lua SSL library includes:
